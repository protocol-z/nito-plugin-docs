...
A private prompt and its response do not reach your harness provider. After submitting, the prompt and response are returned and displayed as a blocked turn.
