...
Free accounts get 10 asks or private prompts a month. Fusion and full sessions need a paid plan. See [Free Usage](/plans/free-usage).
...
That one tool installs the plugin for you and powers setup, file attachments, and private and session launches. Both install guides start here.
