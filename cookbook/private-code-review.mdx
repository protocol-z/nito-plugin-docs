...
**Free-tier single reviewer.** Fusion needs a paid plan; `ask` does not:
...
- **Fusion mixes levels by the strictest rule.** A Fusion of Private-tier models stays Private. Mixing in a lower level would pull the run down, so keep every reviewer at Private or stronger. See [Fusion](/commands/fusion).
