...
Anonymous, Private, and Confidential models can power a session. Encrypted models cannot: the level turns off tools and streaming, which a session needs. See [Models](/models) for the catalog and [Privacy Levels](/privacy/levels) for what each level reaches.
