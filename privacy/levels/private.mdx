...
description: "Open-weight models with zero data retention enforced on the upstream provider."
---

Private is where open-weight models start. The upstream provider is held to **zero data retention**: it is instructed, contractually and technically, not to keep your request after serving it.
