...
Confidential is the top of the ladder you can reach from this release. Encrypted is described in full on its own page, and the plugin refuses an `:encrypted` model until client support ships.
