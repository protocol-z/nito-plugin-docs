...
| **Encrypted** | Pick a model that offers Encrypted | Client-side encryption to the sealed environment |
...
<CardGroup cols={2}>
  ...
  <Card title="Encrypted" href="/privacy/levels/encrypted">
    The top rung, adding client-side encryption to the sealed environment.
  </Card>
</CardGroup>
