...
All four privacy levels are supported. On an Encrypted model the options above do not apply, because the level turns off web search, file attachments, and tools.
